...

{
    ...
    echo "TIO2"                              # Thermodynamic component 7
    echo "MNO"                              # Thermodynamic component 8
    echo "K2O"                              # Thermodynamic component 9    
    ...
    echo "1.82 9.49 13.53 49.2 10.40 10.31 0.80 0.28 0.52 " # Mass amounts for NA2O, MGO, AL2O3, SIO2, CAO, FEO, H2O, CO2
