...

{
    ...
    echo "H2O"                              # Thermodynamic component 7
    echo "CO2"                              # Thermodynamic component 8
    ...
    echo "3.27 2.50 15.40 66.60 3.59 5.00 2.64 1.0" # Mass amounts for NA2O, MGO, AL2O3, SIO2, CAO, FEO
