...
def bilinear_interpolate(T1, P1, Vs1, T2, P2):
    # Create a grid of T1 and P1 with corresponding Vs values from Perple_X
...
write_output_dat(T_litmod, P_litmod_GPa, Z_litmod, Vs_litmod, Vs_interpolated, 'Interpolated_Vs_LitMod.dat')

# Plot all three Vs data
plot_vs_comparison(T_litmod, P_litmod_GPa, Vs_litmod, Vs_interpolated, Z_litmod, 'Vs Comparison: LitMod vs Interpolated', 'Vs_Comparison.png', cmap_interpolated)
