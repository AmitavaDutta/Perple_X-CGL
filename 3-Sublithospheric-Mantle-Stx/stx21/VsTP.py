...
# Extract columns
T_pum, P_pum, rho_pum, Vs_pum = data_pum[:, 0], data_pum[:, 1], data_pum[:, 2], data_pum[:, 3]

# Plot Vs for PUM with 'inferno' colormap
plot(T_pum, P_pum, Vs_pum, rho_pum, 'Vs_PUM', 'Vs_PUM.png', cmap_pum)
